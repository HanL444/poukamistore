...
class Autentifikasi extends CI_Controller
{
    ...
    public function registrasi()
    {
        ...
        //'Password Tidak Sesuai'. jika password diisi kurang dari 3 digit, maka pesannya adalah
        ...
        if($this->form_validation->run()== false) {
            ...
            $this->Member_Model->simpanData($data); //menggunakan model
...
private function _login()
    {
        ...
        $user = $this->Member_Model->cekData(['email' => $email])->row_array();
